...
export function profileFunctional() {
  ...
  userAvatar.nextElementSibling.addEventListener('click', () =>
    changeAvatar(current)
  );
  ...
  applyChangesBtn.addEventListener('click', () => {
    ...
    const repeatNewPass = profile.querySelector(
    ...
    if (
      newPass.value === repeatNewPass.value &&
      newPass.value >= 6 &&
      newPass.value !== '' &&
      repeatNewPass.value !== ''
    ) {
      ...
      return;
    } else if (newPass.value < 6 && newPass.value > 0) {
